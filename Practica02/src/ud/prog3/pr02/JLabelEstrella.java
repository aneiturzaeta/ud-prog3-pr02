...
public class JLabelEstrella extends JLabel{
		...
		public static final int TAMANYO_ESTRE = 40;  // píxels (igual ancho que algo)
		public static final int RADIO_ESFERA_ESTRE = 17;  // Radio en píxels del bounding circle de la estrella (para choques)
		private static final boolean DIBUJAR_ESFERA_ESTRE = true;  // Dibujado (para depuración) del bounding circle de choque del coche
		...
		/** Construye y devuelve el JLabel de la entrella con su gráfico y tamaño
		 */
		public JLabelEstrella() {
			...
			setBounds( 0, 0, TAMANYO_ESTRE, TAMANYO_ESTRE );
...
//			super.paintComponent(g);   // En este caso no nos sirve el pintado normal de un JLabel
	        ...
	        g2.rotate( miGiro, TAMANYO_ESTRE/2, TAMANYO_ESTRE/2 ); // getIcon().getIconWidth()/2, getIcon().getIconHeight()/2 );
	        // Dibujado de la imagen
	        g2.drawImage( img, 0, 0, TAMANYO_ESTRE, TAMANYO_ESTRE, null );
	        if (DIBUJAR_ESFERA_ESTRE) g2.drawOval( TAMANYO_ESTRE/2-RADIO_ESFERA_ESTRE, TAMANYO_ESTRE/2-RADIO_ESFERA_ESTRE,
	        		RADIO_ESFERA_ESTRE*2, RADIO_ESFERA_ESTRE*2 );
		}
}
